...
public class OAuthHelper {
    ...
    public void init() {
        AuthorizationServiceConfiguration.fetchFromUrl(
                ...
                (serviceConfig, e) -> {
                    ...
                    new Thread(() -> {
                        if(e != null) {
                            Timber.e(e, "Failed to fetch OAuth config");
                        ...
                        AuthorizationRequest.Builder authRequestBuilder = new AuthorizationRequest.Builder(
                                serviceConfig,
                                BuildConfig.DEBUG ? apiCred.clientIdDebug() : apiCred.clientId(),
                                ResponseTypeValues.CODE,
                                Uri.parse("com.joshuaau.plantlet:/")
                        );
        ...
        authLauncher = registry.register(UUID.randomUUID().toString(), owner,
                ...
                uri -> {
                    if(uri.getResultCode() == Activity.RESULT_OK) {
                        ...
                        if(data.getData().getQueryParameter("error") != null)
                            return;
                        ...
                        authService.performTokenRequest(resp.createTokenExchangeRequest(),
                                ...
                                (resp1, ex1) -> {
                                    if(ex1 != null) {
                                        Timber.e(ex1, "Failed to complete token request");
    ...
    public static void initEncryptedSharedPrefs(Activity activity) {
        try {
            ...
            Timber.e(e, "Unable to create master key");
    ...
    public void launchOAuth(OAuthCompleteListener oAuthCompleteListener) {
        ...
        try {
            ...
            Timber.e(e, "Unable to launch OAuth intent");
        }
    }
...
//                    TokenRequest request = authState.createTokenRefreshRequest();
                    ...
                    if (ex != null) {
                        Timber.e(ex, "Failed to use access token");
//                        Toast.makeText(context, context.getString(R.string.import_error), Toast.LENGTH_SHORT).show();
    ...
    public AuthState getAuthState() {
        ...
        try {
            ...
            Timber.e(e, "Unable to deserialize auth state JSON");
...
//                .setPostLogoutRedirectUri(Uri.parse("com.joshuaau.plantlet:/"))
//                .build();
//
